  ...
  <section id="services" class="relative py-28 md:py-36">
    <div class="container-x">
      <div class="mx-auto max-w-2xl text-center" v-reveal>
        ...
        <p class="mt-4 text-lg text-white/55">{{ t('services.lead') }}</p>
      </div>
      ...
      >
        <article
          ...
          :key="i"
          class="svc group relative overflow-hidden rounded-xl border border-white/[0.07] bg-white/[0.02] p-7 transition-colors duration-300 hover:border-white/20"
